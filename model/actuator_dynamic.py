...
from model.control_types import ActuatorCommand
...
class ActuatorDynamicConfig:
    ...
    rate limits from TranscriberB and adds those first-order lags.  It is used
...
class ActuatorDynamic:
    ...
    def apply_resource(
        ...
        *,
        ...
        resource_limited = bool(recirc_required)
        vg_limited = False
        ...
        return ResourceApplicationResult(
            ...
            resource_limited=bool(resource_limited),
            Tg_aux_heated=bool(Tg_aux),
            vg_limited_by_stack=bool(vg_limited),
    ...
    def to_command(self, time_s: float, res: ResourceApplicationResult) -> ActuatorCommand:
        return ActuatorCommand(
            ...
            Q_heat_deficit_kW=res.Q_aux_heat_kW,
            resource_limited=res.resource_limited,
            Tg_limited_by_stack=res.Tg_aux_heated,
            vg_limited_by_stack=res.vg_limited_by_stack,
